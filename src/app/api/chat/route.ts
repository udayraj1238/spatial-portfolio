...
const AUTO_SYNCED_REPOS = '\nOTHER RECENT REPOS (auto-synced, not yet in the curated list above):\n- neetcode-submissions [C++]: My NeetCode.io problem submissions (https://github.com/udayraj1238/neetcode-submissions)\n- PulseRAG [Python]: A production-grade, self-correcting RAG pipeline built with LangGraph. Features LLM-based relevance grading, sentence-level hallucination risk scoring, semantic caching, and a human-in-the-loop feedback system. (https://github.com/udayraj1238/PulseRAG)\n- ColdSite-DTI [Jupyter Notebook]: No description set on GitHub yet — add one for better APEX answers. (https://github.com/udayraj1238/ColdSite-DTI)\n- vibe-check [Python]: No description set on GitHub yet — add one for better APEX answers. (https://github.com/udayraj1238/vibe-check)';
